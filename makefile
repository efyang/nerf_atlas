...
fvr: clean
	...
	--size 65 --epochs 10000 --save models/lego_ortho_sphc3sig.pt \
	--batch-size 25	--model fvr -lr 1e-3 --save-freq=500 --skip-loss 100 --decay 1e-5 --clip-gradients 1e-1	\
	--loss-fns l2 --valid-freq 250 --refl-kind multfvrview --sigmoid-kind leaky_relu --no-sched #--load models/lego_ortho_sphc3sig.pt #--omit-bg
...
learnedfvr: clean
	python3 -O runner.py -d data/lego_ortho/ --data-kind ortho \
	--size 65 --epochs 5_000 --save models/lego_ortho_sphc3sig.pt \
	--batch-size 25	--model learnedfvr -lr 1e-2 --save-freq=1000 --clip-gradients 1e-2 --skip-loss 500 --decay 1e-5 \
...
test_learnedfvr: clean
	python3 -O runner.py -d data/lego_ortho/ --data-kind ortho \
	--size 65	--epochs 0 --batch-size 1  \
	--model learnedfvr --refl-kind multfvrview --sigmoid-kind leaky_relu --load models/lego_ortho_sphc3sig.pt #--omit-bg
